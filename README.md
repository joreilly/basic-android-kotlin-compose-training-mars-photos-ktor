...
This app demonstrated the use of [Ktor](https://ktor.io/) to make REST requests to the web service, [kotlinx.serialization](https://github.com/Kotlin/kotlinx.serialization) to
